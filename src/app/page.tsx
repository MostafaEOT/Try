        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              Any service, <span className="text-yellow-300">any time</span>.<br />
              One tap away.
            </h1>
            <p className="text-xl text-blue-100 mb-8 max-w-xl">
              From plumbing to pet grooming — find vetted local professionals for over 150 services, instantly bookable.
            </p>
            <SearchBar large />
            <div className="flex flex-wrap gap-3 mt-5">
              {["🔧 Plumbing", "⚡ Electrical", "🧹 Cleaning", "🌿 Landscaping", "❄️ HVAC", "🐾 Pet Care"].map((tag) => (
                <span key={tag} className="bg-white/10 hover:bg-white/20 border border-white/20 rounded-full px-3 py-1 text-sm cursor-pointer transition-colors">
                  {tag}
                </span>
              ))}
            </div>
